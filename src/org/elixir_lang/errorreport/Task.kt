...
internal class Task(project: Project?,
                    ...
                    private val throwable: List<Throwable>,
    ...
    override fun run(indicator: ProgressIndicator) {
        ...
        try {
            create(additionalInfo, throwable, attachmentList)
    ...
    companion object {
        ...
        private fun create(additionalInfo: String?, throwable: Throwable, attachmentList: List<Attachment>) {
            val request = Request(additionalInfo, throwable, attachmentList)
            BrowserUtil.open(
